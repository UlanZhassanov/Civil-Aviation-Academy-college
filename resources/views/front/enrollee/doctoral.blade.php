...
@section('title')
    Поступление на докторантуру в Академию Гражданской Авиации
@endsection
@section('content')
    <section id="enrollee">
        <div class="container">
            <h1>Онлайн регистрация на докторантуру</h1>
            <div class="enrollee">
                <form action="{{ route('front.enrollee.doctoral.store') }}" method="POST" id="form">
                    @csrf
                    <input type="hidden" name="type" value="Докторантура">
