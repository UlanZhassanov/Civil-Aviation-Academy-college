...
@section('content')
    ...
    <div class="filter">
        <form action="{{ route('admin.graduate.graduates.index') }}">
            @csrf
            <div>
    ...
    <h2>Поиск</h2>
    <div class="filter">
        <form action="{{ route('admin.graduate.graduates.index') }}" method="GET">
            @csrf
            <div>
            ...
            <div>
                <a href="{{ route('admin.graduate.graduates.index') }}"><button>Сбросить фильтры</button></a>
            </div>
        </form>
    </div>
