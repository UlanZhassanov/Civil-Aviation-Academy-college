    ...
    <section id="pages">
        <div class="pages">
            ...
            <div id="lang-blocks" class="mt-3">
                <form action="{{ route('admin.website.news.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div id="ru-block">
                        <div class="mb-4">
                    ...
                    <div class="mb-4 form-check">
                        ...
                        <label class="form-check-label h5" for="flexCheckChecked">
                            Я ознакомлен и несу ответственность за размещение мною информации, согласно закону РК от 23 июля
                            1999 года № 451-I. <br /> Закон <a href="https://adilet.zan.kz/rus/docs/Z990000451_"
                                target="_blank">"о средствах массовой информации"</a>, глава 7, статья 25.
                        </label>
                    </div>
                    <div class="block">
