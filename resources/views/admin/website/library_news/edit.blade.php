    ...
    <section id="pages">
        <div class="pages">
            ...
            <div id="lang-blocks" class="mt-3">
                <form action="{{ route('admin.website.library_news.update', $library_news->id) }}" method="POST"
                    ...
                    <div id="ru-block">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title_ru" value="{!! unserialize($library_news->titles)->ru !!}" class="form-control"
                                required />
                        </div>
                        <div class="mb-4">
                            <label class="font-weight-bold">Описание</label>
                            <textarea name="desc_ru" id="editor-ru" class="form-control">{!! unserialize($library_news->descriptions)->ru !!}</textarea>
                        </div>
                        <div class="mb-4">
                            <label class="font-weight-bold d-block">Фоновое изображение</label>
                            <img src="/storage/library_news/{!! unserialize($library_news->bg_images)->ru !!}" class="mb-2" alt="" width="200"
                                height="150">
                        </div>
                        <div class="mb-4">
                    ...
                    <div id="kk-block" style="display: none">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title_kk" value="{!! unserialize($library_news->titles)->kk !!}" class="form-control">
                        </div>
                        <div class="mb-4">
                            <label class="font-weight-bold">Сипаттамасы</label>
                            <textarea name="desc_kk" id="editor-kz" class="form-control">{!! unserialize($library_news->descriptions)->kk !!}</textarea>
                        </div>
                        <div class="mb-4">
                            <label class="font-weight-bold d-block">Фондық сурет</label>
                            @if (!empty(unserialize($library_news->bg_images)->kk))
                                <img src="/storage/library_news/{!! unserialize($library_news->bg_images)->kk !!}" class="mb-2" alt="" width="200"
                                    height="150">
                            @endif
                        </div>
                        <div class="mb-4">
                    ...
                    <div id="en-block" style="display: none">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title_en" value="{!! unserialize($library_news->titles)->en !!}" class="form-control">
                        </div>
                        <div class="mb-4">
                            <label class="font-weight-bold">Description</label>
                            <textarea name="desc_en" id="editor-en" class="form-control">{!! unserialize($library_news->descriptions)->en !!}</textarea>
                        </div>
                        <div class="mb-4">
                            <label class="font-weight-bold d-block">Background image</label>
                            @if (!empty(unserialize($library_news->bg_images)->en))
                                <img src="/storage/library_news/{!! unserialize($library_news->bg_images)->en !!}" class="mb-2" alt="" width="200"
                                    height="150">
                            @endif
                        </div>
                        <div class="mb-4">
                    ...
                    @if (!empty($library_news->more_images))
                    <br />
                        <div>
                            <label class="font-weight-bold">Дополнительные изображения</label>
                            <div class="d-flex flex-wrap">
                                @foreach (unserialize($library_news->more_images) as $item)
                                    <div class="col-md-2 mb-3 p-0">
                                        <img src="/storage/library_news/{!! $item !!}" class="pl-2 pr-2" alt=""
                    ...
                    <div>
                        ...
                        <input class="form-control" type="datetime-local" name="publish_at"
                            value="{!! date('Y-m-d\TH:i', strtotime($library_news->publish_at)) !!}" disabled>
                    </div>
                    <br />
