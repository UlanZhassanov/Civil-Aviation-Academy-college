        ...
        <div class="pages">
            <div class="pages__head">
                ...
                <div class="pages__add-page">
                    <a href="{{ route('admin.website.studevents.create') }}" class="btn btn-secondary">
                ...
                @foreach ($studevents as $item)
                    <div class="pages__page">
                        ...
                        <div class="text-right d-flex flex-row-reverse" style="width: 30%">
                            <a href="{{ route('admin.website.studevents.edit', $item->id) }}"
                                class="btn btn-primary ml-1">Редактировать</a>
                            <form action="{{ route('admin.website.studevents.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
