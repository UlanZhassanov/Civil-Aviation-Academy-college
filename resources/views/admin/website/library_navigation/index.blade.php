...
@php $active_menu  = 'Меню библиотеки' @endphp
@section('content')
    @if (session('alert'))
    ...
    @endif
    <h1>Управление меню раздела библиотеки</h1>
    <section id="nav">
        <div class="nav">
            <div class="nav__top">
                <h2>Главное меню</h2>
            ...
            <div class="nav__links">
                ...
                @foreach ($tree as $item)
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="col-md-2 text-center">
                            <form class="p-0"
                                action="{{ route('admin.website.library_navigation.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="modal-form" action="{!! route('admin.website.library_navigation.update', $item->id) !!}" method="POST">
                                        @csrf
                                        @method('PUT')
                    ...
                    @if (isset($item->children))
                        @foreach ($item->children as $child)
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="col-md-2 text-center">
                                    <form class="p-0"
                                        action="{{ route('admin.website.library_navigation.destroy', $child->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger"
                            ...
                            <div class="modal fade" id="editModalChild{!! $child->id !!}" tabindex="-1">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="modal-form" action="{!! route('admin.website.library_navigation.update', $child->id) !!}" method="POST">
                                                @csrf
                                                @method('PUT')
                            ...
                            @if (isset($child->children))
                                @foreach ($child->children as $chi)
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="col-md-2 text-center">
                                            <form class="p-0"
                                                action="{{ route('admin.website.library_navigation.destroy', $chi->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger"
                                    ...
                                    <div class="modal fade" id="editModalChi{!! $chi->id !!}" tabindex="-1">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="modal-form" action="{!! route('admin.website.library_navigation.update', $chi->id) !!}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                    ...
                                    @if (isset($chi->children))
                                        @foreach ($chi->children as $ch)
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="col-md-2 text-center">
                                                    <form class="p-0"
                                                        action="{{ route('admin.website.library_navigation.destroy', $ch->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger"
                                            ...
                                            <div class="modal fade" id="editModalCh{!! $ch->id !!}"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="modal-form" action="{!! route('admin.website.library_navigation.update', $ch->id) !!}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
        ...
        <div class="modal fade" id="addModal" tabindex="-1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="modal-form" action="{!! route('admin.website.library_navigation.store') !!}" method="POST">
                            @csrf
                            @method('POST')
